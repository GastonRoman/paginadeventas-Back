const { createApp } = Vue
  ...
  createApp({
    data() {
      return {
        url:"http://paginadeventas.pythonanywhere.com/productos", // Retorna todos los registro de la tabla productos
        productos:[],
        error:false,
        cargando:true
      }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'http://paginadeventas.pythonanywhere.com/borrar/'+id;
            var options = {
                method: 'DELETE',
